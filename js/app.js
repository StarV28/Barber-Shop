 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slide-testimonials__slider")) new core(".slide-testimonials__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slide-testimonials__button-prev",
                    nextEl: ".slide-testimonials__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
...
***************************************************************************** */
        ...
        document.querySelector(".gallery-page__button");
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".slide-item__big-review")) document.documentElement.classList.toggle("slider-text-open");
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
